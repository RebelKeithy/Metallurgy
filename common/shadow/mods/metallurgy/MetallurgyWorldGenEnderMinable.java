...
public class MetallurgyWorldGenEnderMinable extends WorldGenerator
{
    ...
    public MetallurgyWorldGenEnderMinable(int i, int j, int k)
    {
        minableBlockId = i;
        metadata = j;
        numberOfBlocks = k;
            ...
            for(int k2 = i1; k2 <= l1; k2++)
            {
                ...
                for(int l2 = j1; l2 <= i2; l2++)
                {
                    ...
                    for(int i3 = k1; i3 <= j2; i3++)
                    {
                        ...
                        if(d12 * d12 + d13 * d13 + d14 * d14 < 1.0D && world.getBlockId(k2, l2, i3) == Block.whiteStone.blockID)
                        {
                            world.setBlock(k2, l2, i3, minableBlockId);
                            world.setBlockMetadata(k2, l2, i3, metadata);
                        }
                    }
