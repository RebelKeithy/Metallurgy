...
public class RecipeHelper {
	...
	{
		ModLoader.addShapelessRecipe(new ItemStack(ingot, 1, Itemmeta), new Object[] {new ItemStack(blockID, 1, meta)});
		ModLoader.addRecipe(new ItemStack(blockID, 4, meta), new Object[]
        {
