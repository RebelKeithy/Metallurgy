...
public class mod_Bitumen
{
	...
	public static Item bitumen = (new UtilityItem(ConfigUtility.itemBitumenID, "/shadow/MetallurgyUtilityOres.png")).setIconCoord(meta,1).setItemName("Bitumen").setTabToDisplayOn(CreativeTabs.tabMaterials);
	public static Item tar = (new UtilityItem(ConfigUtility.itemTarID, "/shadow/MetallurgyUtilityOres.png")).setIconCoord(meta,2).setItemName("Tar").setTabToDisplayOn(CreativeTabs.tabMaterials);
