...
public class EntityMinersTNTPrimed extends Entity {
    ...
    public EntityMinersTNTPrimed(World par1World)
    {
        super(par1World);
        this.fuse = 0;
    ...
    public EntityMinersTNTPrimed(World par1World, double par2, double par4, double par6)
    {
        this(par1World);
	...
	private void explode()
    {
        ...
        ExplosionMiners explosion = new ExplosionMiners(worldObj, null, this.posX, this.posY, this.posZ, strength);
