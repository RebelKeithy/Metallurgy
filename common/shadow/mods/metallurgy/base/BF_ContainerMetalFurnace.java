...
public class BF_ContainerMetalFurnace extends Container
{
    ...
    public BF_ContainerMetalFurnace(InventoryPlayer par1InventoryPlayer, BF_TileEntityMetalFurnace par2TileEntityMetalFurnace)
    {
        ...
        this.addSlotToContainer(new BF_SlotMetalFurnace(par1InventoryPlayer.player, par2TileEntityMetalFurnace, 2, 116, 35));
        int var3;
    ...
    public ItemStack transferStackInSlot(int par1)
    {
        ...
        if (var3 != null && var3.getHasStack())
        {
            ...
            else if (par1 != 1 && par1 != 0)
            {
                ...
                else if (BF_TileEntityMetalFurnace.isItemFuel(var4))
                {
