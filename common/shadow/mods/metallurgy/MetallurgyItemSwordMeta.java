...
public class MetallurgyItemSwordMeta extends ItemSword
{
	public String texturePath;
    private int weaponDamage;
    private final MetallurgyEnumToolMaterial field_40439_b;

    public MetallurgyItemSwordMeta(int i, String s, MetallurgyEnumToolMaterial metallurgyenumtoolmaterial)
    {
